...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { description: @letter.description, email: @letter.email, name: @letter.name, title: @letter.title } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { description: @letter.description, email: @letter.email, name: @letter.name, title: @letter.title } }
